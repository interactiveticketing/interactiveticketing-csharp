...
namespace InteractiveTicketingSdk.Model
{
        ...
        public partial class ScanPointConfig :  IEquatable<ScanPointConfig>
    {
        ...
        /// </summary>
        /// <param name="">The Scan Point Config ID.</param>
        /// <param name="">The Scan Point Config name.</param>
        /// <param name="">The Scan Point Config resrictions described.</param>
        public ScanPointConfig(int?  = default(int?), string  = default(string), List<string>  = default(List<string>))
        {
            this.ScanPointConfigId = ;
            this.Name = ;
            this.Summary = ;
        }
