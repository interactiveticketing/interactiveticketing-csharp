...
namespace InteractiveTicketingSdk.Model
{
        ...
        public partial class Transaction :  IEquatable<Transaction>
    {
        ...
        /// </summary>
        /// <param name="">The transaction ID.</param>
        /// <param name="">The transaction time iso-8601.</param>
        /// <param name="">The transaction is a refund.</param>
        /// <param name="">The transaction amount.</param>
        /// <param name="">credit | cash | other | triPos.</param>
        /// <param name="">The payment gateway transaction identifier.</param>
        /// <param name="">The payment credit card type code.</param>
        /// <param name="">The payment credit card last four digits.</param>
        /// <param name="">The payment credit card customer name on card.</param>
        /// <param name="">Applicable to refund transaction, reference to the original &#x60;cardTransactionId&#x60;.</param>
        /// <param name="">Billing street address.</param>
        /// <param name="">Billing city.</param>
        /// <param name="">Billing state or province.</param>
        /// <param name="">Billing post code / zip.</param>
        /// <param name="">Billing country.</param>
        /// <param name="">Applicable to refund transactions.</param>
        public Transaction(int?  = default(int?), string  = default(string), bool?  = default(bool?), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string))
        {
            this.TransactionId = ;
            this.DateTime = ;
            this.IsRefund = ;
