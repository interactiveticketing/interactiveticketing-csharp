...
namespace InteractiveTicketingSdk.Model
{
        ...
        public partial class ScanRequest :  IEquatable<ScanRequest>
    {
        ...
        /// <param name="rejectIfSuspicious">Set to true and orders flagged as \&quot;suspicious\&quot; will not be validated.</param>
        /// <param name="scanEvents">Array of ScanEvent configurations.</param>
        public ScanRequest(string barcode = default(string), string gate = default(string), bool? rejectIfSuspicious = default(bool?), List<ScanEvent> scanEvents = default(List<ScanEvent>))
        {
            this.Barcode = barcode;
            this.Gate = gate;
            this.RejectIfSuspicious = rejectIfSuspicious;
        ...
        /// <summary>
        /// Set to true and orders flagged as \&quot;suspicious\&quot; will not be validated
        /// </summary>
        /// <value>Set to true and orders flagged as \&quot;suspicious\&quot; will not be validated</value>
        [DataMember(Name="rejectIfSuspicious", EmitDefaultValue=false)]
        public bool? RejectIfSuspicious { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RejectIfSuspicious: ").Append(RejectIfSuspicious).Append("\n");
        ...
        public bool Equals(ScanRequest input)
        {
            ...
            return 
                ...
                (
                    this.RejectIfSuspicious == input.RejectIfSuspicious ||
                    (this.RejectIfSuspicious != null &&
                    this.RejectIfSuspicious.Equals(input.RejectIfSuspicious))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RejectIfSuspicious != null)
                    hashCode = hashCode * 59 + this.RejectIfSuspicious.GetHashCode();
