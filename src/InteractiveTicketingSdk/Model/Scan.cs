...
namespace InteractiveTicketingSdk.Model
{
        ...
        public partial class Scan :  IEquatable<Scan>
    {
        ...
        /// <param name="time">The scan time iso-8601.</param>
        /// <param name="gate">Gate name identifier string.</param>
        /// <param name="uploadTime">The scan device sync time with server iso-8601.</param>
        /// <param name="method">Ticket format scanned: &#x60;single&#x60; | &#x60;mobile&#x60; | &#x60;passbook&#x60;.</param>
        /// <param name="scanPoint">scanPoint.</param>
        /// <param name="device">device.</param>
        public Scan(int? scanId = default(int?), string time = default(string), string gate = default(string), string uploadTime = default(string), string method = default(string), ScanPoint scanPoint = default(ScanPoint), Device device = default(Device))
        {
            this.ScanId = scanId;
            this.Time = time;
            this.Gate = gate;
