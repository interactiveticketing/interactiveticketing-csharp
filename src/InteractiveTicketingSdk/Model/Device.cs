...
namespace InteractiveTicketingSdk.Model
{
        ...
        public partial class Device :  IEquatable<Device>
    {
        ...
        /// </summary>
        /// <param name="">The scanning device ID.</param>
        /// <param name="">The device last sync time iso-8601.</param>
        /// <param name="">The device last IP address.</param>
        /// <param name="">The device app type.</param>
        /// <param name="">The device app version.</param>
        /// <param name="">The device label.</param>
        /// <param name="">The device OS.</param>
        public Device(int?  = default(int?), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string))
        {
            this.DeviceId = ;
