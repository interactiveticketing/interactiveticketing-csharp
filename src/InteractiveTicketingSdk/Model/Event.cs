...
namespace InteractiveTicketingSdk.Model
{
        ...
        public partial class Event :  IEquatable<Event>
    {
        ...
        /// <param name="">The event name.</param>
        /// <param name="">live | offline | completed.</param>
        /// <param name="">.</param>
        public Event(int?  = default(int?), string  = default(string), string  = default(string), Client  = default(Client))
        {
            this.EventId = ;
            this.Name = ;
            this.Status = ;
