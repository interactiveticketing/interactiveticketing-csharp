...
namespace InteractiveTicketingSdk.Model
{
        ...
        public partial class Order :  IEquatable<Order>
    {
        ...
        /// <param name="dateTime">The order time iso-8601.</param>
        /// <param name="testOrder">True indicates a test order.</param>
        /// <param name="orderType">web | pos | kiosk.</param>
        /// <param name="firstName">Customer first name.</param>
        /// <param name="lastName">Customer last name.</param>
        /// <param name="email">Customer email address.</param>
        /// <param name="phone">Customer phone number.</param>
        /// <param name="mobilePhone">Customer mobile phone number.</param>
        /// <param name="street">Customer street address.</param>
        /// <param name="city">Customer city.</param>
        /// <param name="stateProvince">Customer state or province name.</param>
        /// <param name="country">Customer country.</param>
        /// <param name="postalCode">Customer postal code / zip.</param>
        /// <param name="fees">Organization charged service fee.</param>
        /// <param name="taxes">Organization charged taxes.</param>
        /// <param name="donations">Organization charged donations.</param>
        /// <param name="grandTotal">Total charges.</param>
        /// <param name="coupons">Coupons.</param>
        /// <param name="couponsTotal">Coupons Total.</param>
        /// <param name="iPAddress">Customer IP Address.</param>
        /// <param name="browserName">Customer Browser.</param>
        /// <param name="browserDevice">mobile | desktop.</param>
        /// <param name="sourceCode">Source code passed to the purchase interface s&#x3D;myTrackingCode.</param>
        /// <param name="searchTag">Custom searchTag applied to order to bookmark it.</param>
        /// <param name="survey">Array of additional form question responses.</param>
        /// <param name="transactions">Array of payment/refund transactions.</param>
        /// <param name="tickets">Array of tickets ordered.</param>
        /// <param name="posCashierName">Applicable to pos orders.</param>
        /// <param name="suspectFlags">Array of reasons the order is flagged as suspicious.</param>
        /// <param name="isSuspicious">True indicates if order is flagged as suspicious.</param>
        /// <param name="suspiciousResolved">True indicates if a suspicous order was approved in the dashboard.</param>
        public Order(int? orderId = default(int?), string dateTime = default(string), bool? testOrder = default(bool?), string orderType = default(string), string firstName = default(string), string lastName = default(string), string email = default(string), string phone = default(string), string mobilePhone = default(string), string street = default(string), string city = default(string), string stateProvince = default(string), string country = default(string), string postalCode = default(string), string fees = default(string), string taxes = default(string), string donations = default(string), string grandTotal = default(string), int? coupons = default(int?), int? couponsTotal = default(int?), string iPAddress = default(string), string browserName = default(string), string browserDevice = default(string), string sourceCode = default(string), string searchTag = default(string), List<Survey> survey = default(List<Survey>), List<Transaction> transactions = default(List<Transaction>), List<Ticket> tickets = default(List<Ticket>), string posCashierName = default(string), List<SuspectFlag> suspectFlags = default(List<SuspectFlag>), bool? isSuspicious = default(bool?), bool? suspiciousResolved = default(bool?))
        {
            ...
            this.PosCashierName = posCashierName;
            this.SuspectFlags = suspectFlags;
            this.IsSuspicious = isSuspicious;
            this.SuspiciousResolved = suspiciousResolved;
        }
        ...
        /// <summary>
        /// Array of reasons the order is flagged as suspicious
        /// </summary>
        /// <value>Array of reasons the order is flagged as suspicious</value>
        [DataMember(Name="_suspectFlags", EmitDefaultValue=false)]
        public List<SuspectFlag> SuspectFlags { get; set; }

        /// <summary>
        /// True indicates if order is flagged as suspicious
        /// </summary>
        /// <value>True indicates if order is flagged as suspicious</value>
        [DataMember(Name="_isSuspicious", EmitDefaultValue=false)]
        ...
        [DataMember(Name="_suspiciousResolved", EmitDefaultValue=false)]
        public bool? SuspiciousResolved { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SuspectFlags: ").Append(SuspectFlags).Append("\n");
            sb.Append("  IsSuspicious: ").Append(IsSuspicious).Append("\n");
            sb.Append("  SuspiciousResolved: ").Append(SuspiciousResolved).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Order input)
        {
            ...
            return 
                ...
                (
                    this.SuspectFlags == input.SuspectFlags ||
                    this.SuspectFlags != null &&
                    input.SuspectFlags != null &&
                    this.SuspectFlags.SequenceEqual(input.SuspectFlags)
                ) && 
                (
                    this.IsSuspicious == input.IsSuspicious ||
                    (this.IsSuspicious != null &&
                    this.IsSuspicious.Equals(input.IsSuspicious))
                ) && 
                (
                    this.SuspiciousResolved == input.SuspiciousResolved ||
                    (this.SuspiciousResolved != null &&
                    this.SuspiciousResolved.Equals(input.SuspiciousResolved))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SuspectFlags != null)
                    hashCode = hashCode * 59 + this.SuspectFlags.GetHashCode();
                if (this.IsSuspicious != null)
                    hashCode = hashCode * 59 + this.IsSuspicious.GetHashCode();
                if (this.SuspiciousResolved != null)
                    hashCode = hashCode * 59 + this.SuspiciousResolved.GetHashCode();
                return hashCode;
            }
        }
    }
