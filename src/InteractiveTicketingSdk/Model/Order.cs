...
namespace InteractiveTicketingSdk.Model
{
        ...
        public partial class Order :  IEquatable<Order>
    {
        ...
        public Order(int? orderId = default(int?), string dateTime = default(string), bool? testOrder = default(bool?), string orderType = default(string), string firstName = default(string), string lastName = default(string), string email = default(string), string phone = default(string), string mobilePhone = default(string), string street = default(string), string city = default(string), string stateProvince = default(string), string country = default(string), string postalCode = default(string), string fees = default(string), string taxes = default(string), string donations = default(string), string grandTotal = default(string), int? coupons = default(int?), int? couponsTotal = default(int?), string iPAddress = default(string), string browserName = default(string), string browserDevice = default(string), string sourceCode = default(string), string searchTag = default(string), List<Survey> survey = default(List<Survey>), List<Transaction> transactions = default(List<Transaction>), List<Ticket> tickets = default(List<Ticket>), string posCashierName = default(string))
        {
